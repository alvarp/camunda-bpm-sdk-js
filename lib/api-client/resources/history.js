...
History.activityInstance = function(params, done) {
  ...
  return this.http.post(this.path + '/activity-instance', {
    data: body,
    query: query,
    done: done
  });
...
History.activityInstanceCount = function(params, done) {
  if (arguments.length < 2) {
    done = arguments[0];
    params = {};
  }

  return this.http.get(this.path + '/activity-instance/count', {
    data: params,
    done: done
  });
};
...
History.taskCount = function(params, done) {
  ...
  return this.http.get(this.path + '/task/count', {
    data: params,
    done: done
  });
};
